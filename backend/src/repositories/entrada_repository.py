...
class EntradaRepository:
    ...
    def get_entradas(mail_cliente):
        ...
        cursor.execute("""
          ...
          LEFT JOIN transferencia t ON t.id_entrada = en.id
          WHERE mail_cliente_propietario = %s
        ...
        return [
          {
              ...
              "usada": bool(e["usada"]),
              "transferencia_pendiente": e["id_estado_transferencia"] == 1 if e["id_estado_transferencia"] is not None else False
          }
          for e in entradas
]
...
export function generateMassiveInserts(amount) {
...
export function startConcurrentConnections() {
  return request("/start_connections", {
    method: "GET",
  });
}

export function stopConcurrentConnections() {
  return request("/stop_connections", {
    method: "GET",
  });
}

export function startRollbackTest() {
  return request("/test_rollback", {
    method: "GET",
  });
}

export function startTableLockTest() {
  return request("/test_table_lock", {
    method: "GET",
  });
}

export function startRowLockTest() {
  return request("/test_row_lock", {
    method: "GET",
  });
}

export function startWaitingUpdatesTest() {
  return request("/test_waiting_updates", {
    method: "GET",
  });
}

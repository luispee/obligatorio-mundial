...
type ConfirmBajaFuncionarioModalProps = {
  onClose: () => void;
  onConfirm: () => void;
};

export default function ConfirmBajaFuncionarioModal({
  onClose,
  onConfirm,
}: ConfirmBajaFuncionarioModalProps) {
  return (
    <div
    ...
    >
      <div className="bg-white p-6 rounded-lg w-full max-w-md" onClick={(e) => e.stopPropagation()}>
        ...
        <p className="mb-6">¿Estás seguro de que deseas dar de baja a este funcionario?</p>

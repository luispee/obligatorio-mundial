...
type ConfirmBajaEstadioModalProps = {
  onClose: () => void;
  onConfirm: () => void;
};

export default function ConfirmBajaEstadioModal({
  onClose,
  onConfirm,
}: ConfirmBajaEstadioModalProps) {
  return (
    <div
    ...
    >
      <div className="bg-white p-6 rounded-lg w-full max-w-md" onClick={(e) => e.stopPropagation()}>
        ...
        <p className="mb-6">¿Estás seguro de que deseas dar de baja este estadio?</p>
